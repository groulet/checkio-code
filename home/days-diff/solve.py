...
def days_diff(a, b):
    # create 2 date object from 'a' and 'b'
    # use of * to "unpack" the list as arguments for the function
    # create a timedelta object from the difference and the attribute 'days'
