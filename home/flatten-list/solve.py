'''
https://py.checkio.org/mission/flatten-list/solve/
...
def flat_list(array):
    ...
    for i in array:
        # unpack (*) and call recursively if the item is a list,
        # else just unpack an int with the return array
        a = [*a,*flat_list(i)] if type(i) == list else [*a,i]
    return a
